...
The code is centered in `RectFlowMNIST.ipynb` and is designed to be easy to read, modify, and extend. The implementation stays intentionally compact while still covering the main empirical ideas:
